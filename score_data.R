...
# for(i in 1:1){ # uncomment for testing
  # scoring by file
  # ex of filename
  # ncl_ch_nbtb_QINWU0022_523520_P06_RegistrationExportNarrowStructure_2024-04-30T193955.csv
  ...
  # expected_match <- paste0(instrument_name,'_',match_id,'_RegistrationExportNarrowStructure_')
  # if(expected_exact_match %in% registration_export_files){
  #   print(paste0('exact match: registration export found for: ',expected_exact_match))
  #   registration_export<-read.csv(paste0(registration_export_path,expected_exact_match,timestamp))
  # }else{
